...
public class CustomerStorage
{
    ...
    public void addCustomer(String data)
    {
        ...
        if (components.length != 4){
            throw new InvalidStringFormatException("Wrong format. Correct format: add Василий Петров vasily.petrov@gmail.com +79215637722");
        }
        ...
        if (!components[3].matches(NUMBER_FORMAT)){
            throw new InvalidPhoneNumberException("Wrong phone number format. Correct format: +123456789");
        }
